  ...
  private getGalleryPieces(): GalleryPiece[] {
    const data: Record<string, GalleryPiece[]> = {
      ...
      'InnGenius — Investigación': [
        { id: 1, icon: '🧠', title: 'Pensamiento Creativo', subtitle: 'Fundamento teórico del enfoque pedagógico', content: 'InnGenius se fundamenta en la teoría del pensamiento creativo. Según Menchen (2001, citado en Gutiérrez, 2023), la creatividad es "una característica natural y básica de la mente humana que se encuentra potencialmente en todas las personas" (p. 8). Es decir, la creatividad es una habilidad innata factible de desarrollar y potenciar a través de estrategias adecuadas. Para PISA (2022), el pensamiento creativo se define como "la competencia para participar productivamente en la generación, evaluación y mejora de ideas, que puede dar como resultado soluciones originales y efectivas, avances en el conocimiento y expresiones impactantes de la imaginación" (p. 12). Esta base teórica sustenta que todos los estudiantes pueden desarrollar su potencial creativo si se les brindan las condiciones y estrategias adecuadas.', highlights: ['Creatividad innata (Menchen, 2001)', 'PISA 2022: pensamiento creativo', 'Habilidad potenciable', 'Generación de soluciones originales'] },
        { id: 2, icon: '🎯', title: 'Design Thinking: Fase 1-2', subtitle: 'Empatizar y Definir — comprender para actuar', content: 'EMPATIZAR: Los estudiantes exploran el contexto del problema desde la perspectiva de las personas involucradas. Mediante observación, entrevistas, encuestas y análisis de situaciones reales, buscan comprender necesidades, intereses y dificultades de los usuarios. Esta fase favorece la empatía, el pensamiento crítico y la capacidad para identificar problemas auténticos. DEFINIR: Una vez recopilada la información, los estudiantes organizan y analizan los datos para identificar la necesidad principal o el desafío que será abordado. Se formula un problema claro, específico y relevante que oriente el proceso de diseño. Se fortalecen las habilidades de análisis, síntesis y toma de decisiones.', highlights: ['Observación y entrevistas', 'Identificación de necesidades', 'Formulación del problema', 'Análisis y síntesis'] },
        { id: 3, icon: '💡', title: 'Design Thinking: Fase 3-4', subtitle: 'Idear y Prototipar — crear y materializar', content: 'IDEAR: Se generan múltiples alternativas de solución mediante técnicas de creatividad como lluvia de ideas, mapas mentales, SCAMPER o pensamiento lateral. Se fomenta un ambiente de colaboración donde todas las propuestas son consideradas antes de seleccionar las más viables. El objetivo es potenciar la creatividad, la innovación y el trabajo en equipo. PROTOTIPAR: Las ideas seleccionadas se transforman en prototipos o modelos iniciales que permiten visualizar y experimentar las posibles soluciones. Estos pueden representarse mediante dibujos, maquetas, simulaciones digitales, presentaciones interactivas o recursos tecnológicos. El prototipado facilita el aprendizaje basado en la experimentación y la mejora continua.', highlights: ['Lluvia de ideas y SCAMPER', 'Pensamiento lateral', 'Prototipos tangibles', 'Aprendizaje por experimentación'] },
        { id: 4, icon: '🔄', title: 'Design Thinking: Fase 5', subtitle: 'Evaluar — testear y mejorar', content: 'EVALUAR (TESTEAR): Los prototipos son puestos a prueba con los usuarios o en escenarios simulados para recoger retroalimentación sobre su funcionamiento, utilidad y posibilidades de mejora. Los estudiantes analizan los resultados, realizan ajustes y refinan la propuesta hasta obtener una solución más efectiva. Esta fase fortalece la reflexión, la autoevaluación y el aprendizaje a partir del error como parte del proceso de innovación. La evaluación no es un punto final sino un ciclo continuo que realimenta todo el proceso de Design Thinking, permitiendo iteraciones y mejoras progresivas.', highlights: ['Prueba con usuarios', 'Retroalimentación y ajustes', 'Aprendizaje del error', 'Ciclo continuo de mejora'] },
        { id: 5, icon: '🌐', title: 'Conectivismo y TIC', subtitle: 'Aprendizaje en red en la era digital', content: 'Siemens (2006) define el conectivismo como "la integración de principios explorados por las teorías del caos, redes, complejidad y auto organización. El aprendizaje es un proceso que ocurre dentro de ambientes difusos de elementos centrales cambiantes, que no están completamente bajo el control del individuo" (p. 6). Esta teoría se apropió de fundamentos del constructivismo, según el cual la construcción del conocimiento se logra a partir de la interacción del sujeto con su entorno (Mendoza et al, 2025). En InnGenius, las TIC se integran en cada etapa del Design Thinking: formularios y entrevistas virtuales en Empatizar, mapas conceptuales en Definir, herramientas colaborativas en Idear, aplicaciones de diseño en Prototipar, y plataformas digitales para retroalimentación en Evaluar.', highlights: ['Conectivismo (Siemens, 2006)', 'Constructivismo', 'TIC en cada fase del DT', 'Aprendizaje en red distribuido'] },
        { id: 6, icon: '🏆', title: 'Aportes Innovadores', subtitle: '¿Qué hace único a InnGenius?', content: 'InnGenius se ha consolidado como un pilar fundamental de la cultura institucional, preparando estudiantes para un futuro incierto lleno de desafíos y oportunidades. A través de este programa, desarrollan habilidades esenciales para destacar en un mundo donde la creatividad, la innovación y el emprendimiento son clave. El proyecto demostró que una metodología educativa colombiana puede competir globalmente, con flexibilidad para adaptarse a distintos contextos culturales y una integración del Design Thinking de forma transversal desde preescolar hasta bachillerato. La cultura de innovación está profundamente integrada como un "engranaje" en cada proceso del colegio: desde todas las áreas, estamentos y departamentos se impulsa el desarrollo de habilidades que fomentan este crecimiento.', highlights: ['Metodología colombiana global', 'Engranaje de innovación', 'Transversal K-12', 'Preparación para el futuro'] },
        { id: 7, icon: '📚', title: 'Reflexión y Prospectiva', subtitle: 'Implicaciones para la práctica docente', content: 'La investigación sobre InnGenius revela que propiciar el pensamiento creativo en el aula conlleva a la organización planificada de estrategias donde los estudiantes puedan expresar sus ideas sin temores ni juicios, sintiéndose seguros de que sus contribuciones van más allá de soluciones convencionales. Se requiere activar el pensamiento divergente a través de actividades que van desde la verbalización de ideas hasta el análisis crítico y la evaluación de las mismas en busca del perfeccionamiento. Para el docente, implica transformarse en facilitador de experiencias, diseñando entornos que promuevan la metacognición, el trabajo colaborativo y la conexión entre conocimiento académico y problemas reales. InnGenius demuestra que la innovación educativa no depende de recursos tecnológicos costosos, sino de una visión pedagógica clara y del compromiso de formar estudiantes como protagonistas activos de su aprendizaje.', highlights: ['Docente como facilitador', 'Pensamiento divergente', 'Sin temor al error', 'Visión pedagógica clara'] }
      ]
    };
